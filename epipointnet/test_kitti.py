...
from epipointnet.datasets.kitti import KITTIMonocularStereoPairsSequence

test_dataset_name = "00"

print("Loading Dataset...")
dataset = KITTIMonocularStereoPairsSequence("./data", test_dataset_name, download=True,
                                            f_matrix_algorithm=STD_STEREO_F_MAT_ALGORITHM)
...
for pair in dataset:
    ...
    np.savetxt("./kitti_errs", np.array(l1_alg_errs))
