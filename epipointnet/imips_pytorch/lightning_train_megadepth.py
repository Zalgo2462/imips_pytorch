...
from epipointnet.imips_pytorch.lightning_module import IMIPLightning

parser = ArgumentParser()
parser = IMIPLightning.add_model_specific_args(parser)
args = parser.parse_args([
    "--overfit_n", "50", "--train_set", "megadepth-eiffel-gray", "--eval_set", "tum-mono", "--loss",
    "outlier-balanced-bce-bce-uml", "--model", "strided-simple-conv",
])
